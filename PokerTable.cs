...
public partial class PokerTable : Node2D
{
	...
	public override void _Draw()
	{
		...
		DrawEllipse(center, new Vector2(480, 280), new Color(0.35f, 0.2f, 0.1f), true, -1, true);
		
		// Table felt (green)
		DrawEllipse(center, new Vector2(460, 260), new Color(0.1f, 0.5f, 0.1f), true, -1, true);
		
		// Inner rail (lighter wood)
		DrawEllipse(center, new Vector2(440, 240), new Color(0.4f, 0.25f, 0.15f), false, 8, true);
		
		// Subtle pattern lines on felt
		DrawLine(new Vector2(center.X - 400, center.Y), new Vector2(center.X + 400, center.Y), 
				 new Color(0.08f, 0.45f, 0.08f), 2);
	}
